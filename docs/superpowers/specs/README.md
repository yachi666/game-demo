...
- [Fortune Board Bright Amusement Map Polish Design](./2026-03-29-fortune-board-bright-amusement-map-polish-design.md): superseded design for an earlier bright-amusement visual direction that is no longer the project mainline.
- [Fortune Board Reference Image Full-Screen Battle Design](./2026-04-02-fortune-board-reference-image-full-screen-battle-design.md): canonical design for rebuilding Battle toward the user-provided full-screen reference image with denser HUD, board, and edge-action structure.
- [Fortune Board World Map High-Fidelity Battle Design](./2026-04-02-fortune-board-world-map-high-fidelity-battle-design.md): superseded predecessor design that established the broader world-map direction before the tighter reference-image target.
